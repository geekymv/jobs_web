...
<body>
	<div class="container">
    	...
    	<div class="col-md-2">
      	...
      	<div class="col-md-10">
	        <div class="panel panel-primary">
	          <div class="panel-heading">修改用工单位密码</div>
	          	<div class="row">
		          	<div class="col-md-9">	
		          		<br/>
						 <form action="admin/admin-updateEmployerpwd.do" class=".form-horizontal" method="post">
						   <div class="form-group">
							    <label for="account" class="col-sm-2 col-md-offset-4 control-label">单位账号</label>
							    <div class="col-sm-3">
							      <input type="text" class="form-control focus" id="account" name="account" autofocus="autofocus">
							    </div>
						    ...
						    <div class="form-group">
							    ...
							    <div class="col-sm-3">
							      <input type="password" class="form-control focus" id="password" name="password">
							    </div>
							    <label class="control-label error-info">
